  ...
  board: {
    ...
    columns: [
      //a hoặc b
      {
        ...
        cardOrderIds: ['card-id-07', 'card-id-02', 'card-id-03', 'card-id-04',
           'card-id-05', 'card-id-06', 'card-id-01'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
            ...
            cover: 'https://v2.files.garena.vn/deltaforce/public/development/common/2025/9/24/file.1el6bluaiz.jpeg',
